...
export PROJECT_PATH=".."
cmake -G"MinGW Makefiles" -DCMAKE_TOOLCHAIN_FILE=$CMAKE_TOOLCHAIN_FILE -DCMAKE_MAKE_PROGRAM=$CMAKE_MAKE_PROGRAM -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI="armeabi-v7a" -DLUA_USE_ANDROID=On -DANDROID_NATIVE_API_LEVEL=android-15 $PROJECT_PATH
cmake --build .
